    ...
    */
    public function addColumns(): ?PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('title')
            ->addColumn('description', function (Faq $model){
                if (strlen($model->description) > 100) {
                    $data = substr($model->description, 0, 100);
...
;
    ...
    */
    ...
    {
       try {
           $updated = Faq::query()->find($data['id'])->update([
    ...
    public function updateMessages(string $status, string $field = '_default_message'): string
    {
        $updateMessages = [
            'success'   => [
                '_default_message' => __('Faq has been updated successfully!'),
